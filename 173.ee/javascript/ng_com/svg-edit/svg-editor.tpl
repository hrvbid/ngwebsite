...
<link rel="icon" type="image/png" href="{THISURL}images/logo.png"/>
<link rel="stylesheet" href="{THISURL}jgraduate/css/jPicker.css" type="text/css"/>
<link rel="stylesheet" href="{THISURL}jgraduate/css/jgraduate.css" type="text/css"/>
<link rel="stylesheet" href="{THISURL}svg-editor.css" type="text/css"/>
<link rel="stylesheet" href="{THISURL}spinbtn/JQuerySpinBtn.css" type="text/css"/>

  <script type="text/javascript" src="{THISURL}jquery.js"></script>

<script type="text/javascript" src="{THISURL}js-hotkeys/jquery.hotkeys.min.js"></script>
<script type="text/javascript" src="{THISURL}jquerybbq/jquery.bbq.min.js"></script>
<script type="text/javascript" src="{THISURL}svgicons/jquery.svgicons.js"></script>
<script type="text/javascript" src="{THISURL}jgraduate/jquery.jgraduate.min.js"></script>
<script type="text/javascript" src="{THISURL}spinbtn/JQuerySpinBtn.min.js"></script>
<script type="text/javascript" src="{THISURL}touch.js"></script>

<!--{if svg_edit_release}-->
  <script type="text/javascript" src="svgedit.compiled.js"></script>
<!--{else}>
  <script type="text/javascript" src="{THISURL}contextmenu/jquery.contextMenu.js"></script>
  <script type="text/javascript" src="{THISURL}browser.js"></script>
  <script type="text/javascript" src="{THISURL}svgtransformlist.js"></script>
  <script type="text/javascript" src="{THISURL}math.js"></script>
  <script type="text/javascript" src="{THISURL}units.js"></script>
  <script type="text/javascript" src="{THISURL}svgutils.js"></script>
  <script type="text/javascript" src="{THISURL}sanitize.js"></script>
  <script type="text/javascript" src="{THISURL}history.js"></script>
  <script type="text/javascript" src="{THISURL}select.js"></script>
  <script type="text/javascript" src="{THISURL}draw.js"></script>
  <script type="text/javascript" src="{THISURL}path.js"></script>
  <script type="text/javascript" src="{THISURL}svgcanvas.js"></script>
  <script type="text/javascript" src="{THISURL}svg-editor.js"></script>
  <script type="text/javascript" src="{THISURL}locale/locale.js"></script>
  <script type="text/javascript" src="{THISURL}contextmenu.js"></script>
<!{endif}-->

<!-- you can load extensions here -->
<!-- <script type="text/javascript" src="{THISURL}extensions/ext-helloworld.js"></script> -->

<!-- always minified scripts -->
<script type="text/javascript" src="{THISURL}jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
<script type="text/javascript" src="{THISURL}jgraduate/jpicker.js"></script>
